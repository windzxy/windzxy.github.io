(function(){
  ...
  const VER='20260827-market-color14-emergency-slim-loader';
...
.metals-widget.mdesk .md-range div{background:linear-gradient(90deg,rgba(32,212,122,.28),rgba(255,211,106,.32),rgba(255,77,94,.30))!important}`;
  ...
  document.addEventListener('click',e=>{if(e.target.closest('.metals-widget'))requestAnimationFrame(scan);},true);
