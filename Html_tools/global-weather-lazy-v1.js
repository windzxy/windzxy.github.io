(()=>{
'use strict';
const VERSION='20260911-global-weather-lazy-v1.5-satellite-pan-controls';
...
const SCRIPTS=[
 ...
 ['Html_tools/typhoon-satellite-pan-v1.js','20260911-typhoon-satellite-pan-v1.0-buffered-pan'],
 ...
 ['Html_tools/typhoon-control-layout-v12.js','20260911-typhoon-control-layout-v12.0-centered-controls']
];
...
window.WebDeskGlobalWeatherLazy={version:VERSION,get loaded(){return loaded},activate,scripts:SCRIPTS.map(x=>x[0]),performanceProfile:'buffered-satellite-pan+centered-controls+cached-debounced-forecast-panzoom+provider-failover'};
})();