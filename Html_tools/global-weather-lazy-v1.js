(()=>{
'use strict';
const VERSION='20260913-global-weather-lazy-v3.4-human-ui';
...
const SCRIPTS=[
 ...
 ['Html_tools/typhoon-radar-v4-1.js','20260913-typhoon-radar-v4.6-visibility-idle'],
 ['Html_tools/typhoon-atmosphere-v5-1.js','20260902-typhoon-atmosphere-v5.2-sync'],
 ['Html_tools/typhoon-satellite-pan-v1.js','20260912-typhoon-satellite-pan-v1.4-visibility-idle'],
 ...
 ['Html_tools/typhoon-control-layout-v13.js','20260913-typhoon-control-layout-v13.2-human-ui']
];
...
window.WebDeskGlobalWeatherLazy={version:VERSION,get loaded(){return loaded},activate,scripts:SCRIPTS.map(x=>x[0]),performanceProfile:'human-ui+shared-overlay-motion+post-settle-staggered-forecast-city-vector+visibility-idle+satellite-visibility-idle+radar-visibility-idle+single-layout-owner'};
})();