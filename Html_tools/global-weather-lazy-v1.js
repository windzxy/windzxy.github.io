(()=>{
'use strict';
const VERSION='20260911-global-weather-lazy-v1.9-motion-debounced-cities';
...
window.WebDeskGlobalWeatherLazy={version:VERSION,get loaded(){return loaded},activate,scripts:SCRIPTS.map(x=>x[0]),performanceProfile:'motion-debounced-city-labels+zoom-tiered-city-labels+zoom-tiered-city-labels+single-layout-owner+no-tile-fade+buffered-satellite-pan+cached-debounced-forecast-panzoom+provider-failover'};
})();