(function(){
  const groups=[
    ...
    {id:'games',title:'棋類遊戲',items:['gomoku','chess','xiangqi','flight-chess']},
  ...
  groupedRenderShelf();
  window.WebDeskToolboxCategories={version:'v10-games-flight-chess',groups:groups.map(g=>g.id),render:groupedRenderShelf,shortcuts:{focusSearch:'/',clearSearch:'Escape'},categorySearch:true,classSchedule:true,descriptions:true,lifestyle:true,games:true,xiangqi:true,flightChess:true};
})();