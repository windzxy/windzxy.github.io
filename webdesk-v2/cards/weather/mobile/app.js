...
export async function mount({host,signal}){
  ...
  async function render(location=null){
    ...
    host.innerHTML=`<section class="weather-app weather-app-mobile">
      ...
      <section class="weather-mobile-metrics" aria-label="天氣詳情"><article><small>濕度</small><strong>${d.humidity}%</strong></article><article><small>風</small><strong>${d.wind} <i>km/h</i></strong></article><article><small>陣風</small><strong>${d.gust} <i>km/h</i></strong></article><article><small>UV</small><strong>${d.uv}</strong></article></section>
