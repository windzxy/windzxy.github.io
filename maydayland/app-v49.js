(() => {
  ...
  function render(force=false,target=null){
    ...
    const live=$('.v45-live'); if(live)live.innerHTML='<span>Timeline archive</span><b>v49 LIVE</b>';
    const footer=$('.v45-footer'); if(footer)footer.textContent='Maydayland v49 · Timeline / Archive 2.0 · next: v50 cross-page search + source registry';
  }
