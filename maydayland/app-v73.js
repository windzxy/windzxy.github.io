(() => {
  ...
  addEventListener('load',()=>setTimeout(()=>{optimizeMedia();const load=renderLoad(document.querySelector('.v70-integrity'));renderBundleAudit(load);},220),{once:true});
